...
class CudaFunctions_Double : public CudaFunctions_Base
{
protected:
	...
	DeviceMatrix matrix_diagflat(DeviceMatrix device_matrix, bool on_hold);
	DeviceMatrix double_to_complex(DeviceMatrix device_matrix, bool on_hold);

public:
	CudaFunctions_Double() : CudaFunctions_Base() { printf("\nCreating CudaFunctions_Double...\n");  precision = 2; };
	~CudaFunctions_Double();
	...
	DeviceMatrix diag(DeviceMatrix device_matrix, bool on_hold = false);
